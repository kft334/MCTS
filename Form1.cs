    ...
    public partial class Form1 : Form
    {
        ...
        public void Supersim(bool showPlus)
        {
            try
            {
                ...
                for (int i = 0; i < superSim.X_YMin_YAv_YMax.Count() - 1; i++)
                {
                    plot.AddLine(superSim.X_YMin_YAv_YMax[i].Item1, (double)superSim.X_YMin_YAv_YMax[i].Item3, superSim.X_YMin_YAv_YMax[i + 1].Item1, (double)superSim.X_YMin_YAv_YMax[i + 1].Item3);
                }
